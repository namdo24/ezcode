    ...
    <div id="loader" class="loader orange-color">
        <div class="loader-container">
            <div class='loader-icon'>
                <img src="/assets/client/assets/images/pre-logo1.png" alt="">
            </div>
        </div>
    </div>
                        ...
                        <div class="row y-middle">
                            <div class="col-lg-2">
                                <div class="logo-cat-wrap">
                                    <div class="logo-part">
                                        <a href="/">
                                            <img class="normal-logo" src="/assets/client/assets/images/lite-logo.png" alt="">
                                            <img class="sticky-logo" src="/assets/client/assets/images/dark-logo.png" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <nav class="rs-menu">
                                            ...
                                            <li class="menu-item-has-children">
                                                    ...
                                                    <ul class="sub-menu"> 
                                                        ...
                                                        <li><a href="/course/{{$category['c_id']}}/list">{{$category['c_name']}}</a></li> 
                                                        @endforeach                                                   
                                                    ...
                                                    <ul class="cart-icon-product-list">
                                                        <li class="display-flex">
                                                            ...
                                                            <div class="product-image">
                                                                <a href="cart.html"><img src="/assets/client/assets/images/shop/1.jpg"
                                                                        alt="Product Image"></a>
                                                            </div>
                                                        </li>
                                                        <li class="display-flex">
                                                            ...
                                                            <div class="product-image">
                                                                <a href="cart.html"><img src="/assets/client/assets/images/shop/2.jpg"
                                                                        alt="Product Image"></a>
                                                            </div>
                                                        </li>
                                                    </ul>
                    ...
                    <div class="container">
                        <div class="content-part">
                            <div class="sl-sub-title wow bounceInLeft" data-wow-delay="300ms"
                                data-wow-duration="2000ms">Bắt đầu học ngay hôm nay</div>
                            <h1 class="sl-title wow fadeInRight" data-wow-delay="600ms" data-wow-duration="2000ms">
                                Khóa học trực tuyến từ các giáo viên hàng đầu</h1>
                    ...
                    <div class="container">
                        <div class="content-part">
                            <div class="sl-sub-title wow bounceInLeft" data-wow-delay="300ms"
                                data-wow-duration="2000ms">Bắt đầu học ngay hôm nay</div>
                            <h1 class="sl-title wow fadeInRight" data-wow-delay="600ms" data-wow-duration="2000ms">
                                Khám phá khóa học với nhiều chủ đề khác nhau</h1>
                            <div class="sl-btn wow fadeInUp" data-wow-delay="900ms" data-wow-duration="2000ms">
                                <a class="readon orange-btn main-home" href="#">Tìm kiếm khóa học</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12 md-mb-30">
                            <div class="features-wrap">
                                <div class="icon-part">
                                    <img src="/assets/client/assets/images/features/icon/3.png" alt="">
                                </div>
                                <div class="content-part">
                                    <h4 class="title">
                                        <span class="watermark">Hàng trăm khóa học trực tuyến</span>
                                    </h4>
                                    <p class="dese">
                        ...
                        <div class="col-lg-4 col-md-12 md-mb-30">
                            <div class="features-wrap">
                                <div class="icon-part">
                                    <img src="/assets/client/assets/images/features/icon/2.png" alt="">
                                </div>
                                <div class="content-part">
                                    <h4 class="title">
                                        <span class="watermark">Hướng dẫn chuyên môn</span>
                                    </h4>
                                    <p class="dese">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="features-wrap">
                                <div class="icon-part">
                                    <img src="/assets/client/assets/images/features/icon/1.png" alt="">
                                </div>
                                <div class="content-part">
                                    <h4 class="title">
                                        <span class="watermark">Truy cập trọn đời khi mua </span>
                                    </h4>
                                    <p class="dese">
